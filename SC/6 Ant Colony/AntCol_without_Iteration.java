...
public class AntCol_without_Iteration {
    ...
    public AntCol_without_Iteration() {
        pher = new double[N][N];
        runScenario();
    }

    void runScenario() {
        log("=== Starting scenario: 3 given ants + 4th ant only (RHO=0) ===");
    ...
    public static void main(String[] args) {
        new AntCol_without_Iteration(); // console-only; runs up to 4th ant and stops
    }
}
